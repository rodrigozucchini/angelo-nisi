...
import Nisi from './../../assets/nisi.jpg';

const Storytelling = () => {
  return (
    <div className="story">
      <h1 className="title-story">ASÍ LOGRÉ CUMPLIR MIS METAS CUANDO ESTABA EN TU LUGAR…</h1>
        <img className="img-story" src={Nisi} />
        <span>
            <p className="story-text"><b>Cada vez son más los emprendedores digitales que sufren de ansiedad a diario a causa de no tener un plan financiero que les permita lograr sus metas.</b>
                <br />
                <br />
                ...
                <br /> 
                <br />
                La mayoría de los emprendedores digitales hoy...
                <br />
                - No tienen un plan de ahorro mensual, ni disciplina para hacerlo
                <br />
                - No tienen una estructura de gastos acorde a sus hábitos
                <br />
                - No llevan un control y progreso de sus inversiones (si las tienen)
                <br />
                <br />
                Entre muchos otros fallos, y <b>el problema principal es que no saben por donde empezar a solucionarlos. </b>
                <br />
                <br />
                Yo estuve en tu situación, veía más lejos que cerca tener ese estatus de libre financieramente hasta que un día...
                <br />
                <br />
